...
#unpack data
time, freq, flux, flux_err = np.genfromtxt('../Data_Generation/data/realistic_data.csv',delimiter=',',skip_header=1,unpack=True)
...
if __name__ == "__main__":
    splr.run_sampling([time,freq],flux,initial,flux_err,d_L=d_L,z=z,steps=1,processes=40,genfile=1,parallel_optimization=0,nwalkers=32,filename='/data/PROJECTS/2024-25/cjc233/Large_data/realisitic_samples.h5')


    file_path = '/data/PROJECTS/2024-25/cjc233/Large_data/realisitic_samples.h5'
    ...
    plt.savefig('./graph/ac_realistic.png')
    plt.close()
