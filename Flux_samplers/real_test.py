...
F[time_indices, freq_indices] = flux
f_err[time_indices, freq_indices] = flux_err
...
if __name__ == "__main__":
    splr.run_sampling([t,nu],F,initial,err,d_L=d_L,z=z,steps=10,processes=4,genfile=1,filename='../../../Large_data/Real_Data.h5')
