...
if __name__ == "__main__":
    splr.run_sampling([time,freq],flux,initial,flux_err,d_L=d_L,z=z,steps=1,processes=40,genfile=1,parallel_optimization=0,nwalkers=32,filename='../../../Large_data/early_samples.h5')


    file_path = '../../../Large_data/early_samples.h5'
    ...
    plt.savefig('./graph/early_ac.png')
    plt.close()
