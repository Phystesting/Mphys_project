...
bounds = [(51, 54), (0, np.pi*0.5),(0, 0.7), (0, np.pi*0.5),(0, 10**3), (2.1, 3.0),(0, 1), (0, 1)]  # 
...
print("epsilon_e = {0:.3f}".format(epsilon_e_ml))
print("epsilon_B = {0:.3f}".format(epsilon_B_ml))

def log_prior(theta):
    E0, thetaObs,thetaCore,thetaWing,n0,p,epsilon_e,epsilon_B = theta
    if 51 < E0 < 54 and 0 < thetaObs < np.pi*0.5 and 0 < thetaCore < 0.7 and 0 < thetaWing < np.pi*0.5 and 0 < n0 < 10**3 and 1.8 < p < 3.0 and 0 < epsilon_e < 1 and 0 < epsilon_B < 1:
        return 0.0
    return -np.inf
