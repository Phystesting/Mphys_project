...
def ag_t(t,nu_in, thetaObs, thetaCore, thetaWing, n0, p, epsilon_e, epsilon_B, E0):
...
def ag_freq(nu,t, thetaObs, thetaCore, thetaWing, n0, p, epsilon_e, epsilon_B, E0):
	# Function to calculate the model
	Z = {
		'jetType': grb.jet.Gaussian,
		'specType': grb.jet.SimpleSpec,
...
def run_optimization(x, y,initial,datatype=0):
...
def run_sampling(x, y, initial,datatype=0, steps=100, nwalkers=32, processes=4,filename="./data/test_sample.h5"):
