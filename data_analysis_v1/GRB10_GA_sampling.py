...
filename = '/data/PROJECTS/2024-25/cjc233/Large_data/GRB10_GA_samples.h5'

# Unpack data
time, freq, flux, Ub_err, Lb_err = np.genfromtxt('../data_generation_v1/data/GRB10_data.csv',delimiter=',',skip_header=1,unpack=True)
