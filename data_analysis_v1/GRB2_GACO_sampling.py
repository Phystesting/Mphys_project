...
filename = '/data/PROJECTS/2024-25/cjc233/Large_data/GRB2_GACO_samples.h5'
...
#splr.run_optimization([time,freq], flux, initial,fixed_params, flux_err, xi_N, d_L, z,jet_type=jet_type)
