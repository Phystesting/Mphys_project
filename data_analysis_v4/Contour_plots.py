...
sampling_plot_path = f'./graph/{identifier}/{identifier}_{fit_type}{extra}_steps.png'
...
corner_plot_path = f'./graph/{identifier}/{identifier}_{fit_type}{extra}_contour.png'
